namespace BouchonUniversel.Utils.Utils
{
    #region Usings
    ...
    public static class Strings
    {
        ...
        public static string ArgumentIsEmpty([CanBeNull] object argumentName) => string.Format(
            CultureInfo.CurrentCulture,
            GetString("ArgumentIsEmpty", "argumentName"),
            new[] { argumentName });
        ...
        /// <returns>The <see cref="string" />.</returns>
        public static string ArgumentPropertyNull([CanBeNull] object property, [CanBeNull] object argument) => string.Format(
            CultureInfo.CurrentCulture,
            GetString("ArgumentPropertyNull", "property", "argument"),
            property,
            argument);
        ...
        /// <param name="argumentName">The argument Name.</param>
        /// <returns>The <see cref="string" />.</returns>
        public static string CollectionArgumentIsEmpty([CanBeNull] object argumentName) => string.Format(
            CultureInfo.CurrentCulture,
            GetString("CollectionArgumentIsEmpty", "argumentName"),
            new[] { argumentName });
