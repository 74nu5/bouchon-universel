namespace BouchonUniversel.Utils.Utils
{
    ...
    public static class Strings
    {
        ...
        static Strings()
            => ResourceManager = new ResourceManager("Adm.Cds.Common.Standard.Properties.CoreStrings", typeof(Strings).GetTypeInfo().Assembly);
        ...
        /// <returns>The <see cref="string" />.</returns>
        [CanBeNull]
        public static string GenererInitiales([CanBeNull] this string nom)
            => nom?.Substring(0, 1).ToUpper();
        ...
        public static string InvalidEntityType([CanBeNull] object type, [CanBeNull] object argumentName)
            => string.Format(CultureInfo.CurrentCulture, GetString("InvalidEntityType", "type", "argumentName"), new[] { type, argumentName });
