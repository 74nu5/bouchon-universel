namespace BouchonUniversel.Utils.Json
{
    #region Usings
    ...
    public static class JsonExtensions
    {
        ...
        public static string ToJson<T>([NotNull] this T obj)
            => JsonConvert.SerializeObject(obj, obj.GetType(), Formatting.Indented, null);
